...
from nnformer.network_architecture.swin_transformer_3d import SwinTransformer3D
from nnformer.network_architecture.vision_transformer import SwinUnet3D
...
class nnFormerTrainerV2_WMHNew(nnFormerTrainer):
    """
