...
from WMH.inference.segmentation_export import save_segmentation_nifti_from_softmax, save_segmentation_nifti
...
from WMH.postprocessing.connected_components import load_remove_save, load_postprocessing
from WMH.training.model_restore import load_model_and_checkpoint_files
from WMH.training.network_training.WMHTrainer import WMHTrainer
from WMH.training.network_training.WMHTrainer_synapse import WMHTrainer_synapse

from WMH.utilities.one_hot_encoding import to_one_hot
...
def preprocess_multithreaded(trainer, list_of_lists, output_files, num_processes=2, segs_from_prev_stage=None):
    ...
    assert isinstance(trainer, WMHTrainer) or isinstance(trainer, WMHTrainer_synapse)
    q = Queue(1)
    processes = []
