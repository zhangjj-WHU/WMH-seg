...
from WMH.inference.predict import predict_from_folder
from WMH.paths import default_plans_identifier, network_training_output_dir, default_cascade_trainer, default_trainer
from batchgenerators.utilities.file_and_folder_operations import join, isdir
from WMH.utilities.task_name_id_conversion import convert_id_to_task_name
from WMH.paths import network_training_output_dir, preprocessing_output_dir, default_plans_identifier
from WMH.run.default_configuration import get_default_configuration
...
def main():
    ...
    parser.add_argument('-tr', '--trainer_class_name',
                        help='Name of the WMHTrainer used for 2D U-Net, full resolution 3D U-Net and low resolution '
    ...
    parser.add_argument('-z', '--save_npz', required=False, action='store_true',
                        help="use this if you want to ensemble these predictions with those of other models. Softmax "
                             ...
                             "merged between output_folders with WMH_ensemble_predictions")
